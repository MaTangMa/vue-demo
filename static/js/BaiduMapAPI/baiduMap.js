...
window.BMAP_AUTHENTIC_KEY = "4MGcH34tesfZMXyywxmMKGdgz9ji4OCs";
(function() {
    function aa(a) {
        throw a;
    }
    ...
    pd.getTilesUrl = function(a, b) {
        ...
        return (kd[Math.abs(c + e) % kd.length] + "?qt=tile&x=" + (c + "").replace(/-/gi, "M") + "&y=" + (e + "").replace(/-/gi, "M") + "&z=" + b + "&styles=sl" + (6 == z.ca.ia ? "&color_dep=32&colors=50" : "") + "&udt=" + f).replace(/-(\d+)/gi, "M$1")
    }
    ;
