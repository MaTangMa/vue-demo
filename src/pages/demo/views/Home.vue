      ...
      <div class="navmenu">
        <el-menu default-active="1-1" class="el-menu-vertical-demo" @open="handleOpen" @close="handleClose">
          ...
          <el-submenu index="2">
            ...
            <el-menu-item index="2-1">水库预警规则管理</el-menu-item>
            <el-menu-item index="2-2">预警发布</el-menu-item>
            <el-menu-item index="2-2">预警措施</el-menu-item>
            <el-menu-item index="2-2">预警反馈</el-menu-item>
          </el-submenu>
